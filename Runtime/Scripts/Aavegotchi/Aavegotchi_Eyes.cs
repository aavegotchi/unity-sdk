...
public class Aavegotchi_Eyes : MonoBehaviour
{
    ...
    {
        foreach (var (key, GOEyeShape) in EyeMap)
        {
            if (GOEyeShape.LeftEye != null)
            {
                GOEyeShape.LeftEye.SetActive(key == eyeShape);
            }
            if (GOEyeShape.RightEye != null)
            {
                GOEyeShape.RightEye.SetActive(key == eyeShape);
            }
            ...
            if (key == eyeShape)
            {
                ...
                if (GOEyeShape.LeftEye != null && GOEyeShape.LeftEye.TryGetComponent<Aavegotchi_EyeColor>(out var leftColorer))
                {
                    leftColorer.UpdateEyeColors(primaryMaterial, secondaryMaterial, eyeColor);
                }

                if (GOEyeShape.RightEye != null && GOEyeShape.RightEye.TryGetComponent<Aavegotchi_EyeColor>(out var rightColorer))
                {
                    rightColorer.UpdateEyeColors(primaryMaterial, secondaryMaterial, eyeColor);
                }
            }
        }
    }
